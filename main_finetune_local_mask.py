...
import models.models_local_vit as models_vit
from models.meta_baseline import MetaBaseline
from models.soft_focal_loss import soft_focal_loss

import models.models_localization as models_localization

from engines.engine_finetune_local_mask import train_one_epoch, evaluate, meta_evaluate, class_evaluate
...
def main(args):
    ...
    # localization model loading
    local_model = models_localization.__dict__['vit_base_patch16'](
            num_classes=64,
            drop_path_rate=0.1,
        )
    
    ckpt_path = 'output/finetune/localization/standard/checkpoint-99.pth'
    ...
    msg = local_model.load_state_dict(checkpoint_model, strict=False)
    print(msg)
    ...
    for epoch in range(args.start_epoch, args.epochs):
        ...
        train_stats = train_one_epoch(
            local_model, model, criterion, data_loader_train,
